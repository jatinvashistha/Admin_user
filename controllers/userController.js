...
//  
 ...
 export const updateUser = catchAsyncError(async (req, res, next) => {
  ...
  if (user.role !== 'admin') {
    return next(new ErrorHandler("Permission denied. Only admins can update user details.", 403));
  }
...
export const updateUserImage = catchAsyncError(async (req, res, next) => {
  ...
  // Check if the logged-in user is an admin
  if (user.role !== 'admin') {
    return next(new ErrorHandler("Permission denied. Only admins can update user image.", 403));
  }
